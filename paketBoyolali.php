...
$query = "SELECT * FROM paket WHERE id_kota = (SELECT id_kota FROM kota WHERE nama_kota = 'Boyolali')";
...
<body>
    ...
    <!-- PILIH PAKET -->
    <section class="pilih">
        <h2>Pilih paket kesukaan Anda di Boyolali!</h2>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Tidak ada data paket di Boyolali.";
        }
        ?>
