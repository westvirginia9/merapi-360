    ...
    <section>
        ...
        <div class="formulir">
            <div class="datadiri">
                ...
                <div class="wrapper">
                    ...
                    <div class="label-input">
                        ...
                        <input type="text" id="telfon" placeholder="Masukkan nomor telepon Anda">
                    </div>
            ...
            <div class="pesanan">
                ...
                <div class="produk">
                    <img src="assets/ullen-sentalu.jpg" alt="p">

                    <input type="text" id="paket" placeholder="Nama Paket" disabled>
                    <input type="text" id="harga" placeholder="Harga Paket" disabled>
                    <input type="text" id="tiket" placeholder="Tiket" disabled>
                </div>

                <div class="total-harga">
                    <label for="total">Total Harga:</label>
                    <input type="text" id="total" placeholder="Jumlah Total" disabled>
                </div>
